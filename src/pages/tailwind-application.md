...
During the development process of the [Nimiq Developer Center](https://github.com/onmax/nimiq-developer-center), I noticed that we often lack standardised CSS libraries on Nimiq, which leads to frequent code duplication. To address this, I've released [two new libraries](https://github.com/onmax/nimiq-ui) tailored to the Nimiq design system to improve our development workflow and give more resources to our developer community. I've detailed the process of creating these libraries in my blog: ["The Evolution"]() and [Nimiq Icons]().
